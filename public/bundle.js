...
var _cartAction = __webpack_require__(50);

var _booksaction = __webpack_require__(51);
...
var _bookList = __webpack_require__(54);
...
*/
var ba=__webpack_require__(4),m=__webpack_require__(9),A=__webpack_require__(2),C=__webpack_require__(1),ea=__webpack_require__(10),fa=__webpack_require__(11),ha=__webpack_require__(12),ja=__webpack_require__(3);
...
var _booksReducers = __webpack_require__(48);

var _cartReducers = __webpack_require__(49);
...
function booksReducers() {
	...
	switch (action.type) {
		case "GET_BOOKS":
			return _extends({}, state, { books: [].concat(_toConsumableArray(state.books)) });break;
		...
		case "updateBook":
			var booktoupdate = [].concat(_toConsumableArray(state.books));
			var indextoupdate = booktoupdate.findIndex(function (book) {
				return book.id === action.payload.id;
			});

			var updatedbook = _extends({}, booktoupdate[indextoupdate], { title: action.payload.title });

			return { books: [].concat(_toConsumableArray(booktoupdate.slice(0, indextoupdate)), [updatedbook], _toConsumableArray(booktoupdate.slice(indextoupdate + 1))) };
			break;
	}
	return state;
}
...
var Booklist = function (_Component) {
  ...
  _createClass(Booklist, [{
    ...
    value: function render() {
      var bookList = this.props.books.map(function (books) {
